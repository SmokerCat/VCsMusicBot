...
def song(client, message):
    ...
    try:
        ...
        print(str(e))
        return
    m.edit("```Downloading and Uploading the song...```")
    try:
        with youtube_dl.YoutubeDL(ydl_opts) as ydl:
            info_dict = ydl.extract_info(link, download=False)
            audio_file = ydl.prepare_filename(info_dict)
            ydl.process_info(info_dict)
        rep = "**🎵 Uploaded by @Aami_song_bot** \n\nIf you found Any Error please Report [Here](https://t.me/Cat_Telegram_Project_Club) \n\nSong Module Created By [CatX](https://t.me/Cat_of_TelegramX)"
        ...
        m.edit("```❌ Error...Report Here...[Support](https://t.me/Cat_Telegram_Project_Club)")
        print(e)
